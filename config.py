...
class Config:
    ...
    MODELS_REQUIRING_PARENT_ID = os.getenv(
        ...
        "qwen3.6-plus,qwen3.5-plus,qwen3.5-omni-plus,qwen3.5-flash,qwen3.5-max-preview,qwen3.6-plus-preview,qwen3.5-397b-a17b,qwen3.5-122b-a10b,qwen3.5-omni-flash,qwen3.5-27b,qwen3.5-35b-a3b,qwen3-max,qwen3-235b-a22b-2507,qwen3-coder,qwen3-vl-235b-a22b,qwen3-omni-flash,qwen2.5-max"
    ).split(",")
